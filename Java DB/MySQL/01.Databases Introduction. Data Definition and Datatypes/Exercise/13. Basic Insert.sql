...
INSERT INTO employees (`first_name`, `middle_name`, `last_name`, `job_title`, `department_id`, `hire_date`, `salary`)
	VALUES ('Ivan', 'Ivanov', 'Ivanov', '.NET Developer', (SELECT `id` FROM `departments` WHERE `name` = 'Software Development' ), '2013-02-01', 3500.00),
...
-- SELECT CONCAT_WS(' ', `first_name`, `middle_name`, `last_name`) AS `name`, `job_title`, (SELECT `name` FROM `departments` WHERE `id` = `department_id`) AS `department`, `hire_date`, `salary` FROM `employees`;
