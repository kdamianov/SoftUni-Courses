...
public class EntityManager<E> implements DbContext<E> {
    ...
    private final Connection connection; //присвояваме само веднъж --> final
    ...
    public boolean persist(E entity) throws IllegalAccessException, SQLException {
        ...
        return false;
        //TODO: return updateEntity(entity);
    }
    ...
    private boolean insertEntity(E entity) throws SQLException {
        ...
        String fieldValuesWithoutId = getFieldValuesWithoutId(entity); //Подаваме самият обект, тк ще извадим от него стойностите, които ни трябват
