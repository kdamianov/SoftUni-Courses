...
public class ControllerImpl implements Controller {
    ...
    public String addState(String stateName, String... exhibits) {
        ...
        //метод за добавяне на {String... exhibits} в {stateExhibits}
    ...
    public String exploreState(String stateName) {
        ...
        List<Explorer> validExplorers = this.explorerRepository
        ...
        long exhaustedExplorers = validExplorers.stream().filter(e -> e.getEnergy() == 0).count();
        exploredStates ++;

        return String.format(STATE_EXPLORER, stateToExplore.getName(), exhaustedExplorers);
    }
    ...
    public String finalResult() {
        ...
        for (Explorer explorer : this.explorerRepository.getCollection()) {
            ...
            if (explorer.getSuitcase().getExhibits().isEmpty()) {
                ...
                String exhibits = String.join(FINAL_EXPLORER_SUITCASE_EXHIBITS_DELIMITER, explorer.getSuitcase().getExhibits());
