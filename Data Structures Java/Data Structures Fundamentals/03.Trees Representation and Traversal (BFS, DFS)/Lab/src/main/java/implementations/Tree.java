...
public class Tree<E> implements AbstractTree<E> {
    ...
    public Tree(E value, Tree<E>... subtrees) {
        //varargs - за да имаме възможност да добавяме поредица от дървета като ДЕЦА
        this.value = value;
        this.parent = null;
        ...
        //посочваме както child така и parent!
    }
    ...
    public List<E> orderBfs() {
        ...
        childrenQueue.offer(this); //добавяме дървото, за да може да се изпълни долният цикъл, иначе ще е винаги празен
...
//        ArrayDeque<Tree<E>> treeStack = new ArrayDeque<>();
//        treeStack.push(this);
//
//        while (!treeStack.isEmpty()) {
//            Tree<E> current = treeStack.pop();
//
...
//        }
    ...
    private void doDFS(Tree<E> node, List<E> result) {
        ...
        result.add(node.value); //добавяме в списъка, когато вече няма деца
    }
